...
#@onready var mini_room := preload("res://mini_room.tscn")
...
#func update_minimap(direction, prev_mini_room):
#	var mini_room_instance
#	match(direction):
#		"N":
#			mini_room_instance = mini_room.instantiate()
#			mini_room_instance.position = prev_mini_room.position + Vector2(0, -24)
#			$HUD/MiniRooms.add_child(mini_room_instance)
#		"S":
#			mini_room_instance = mini_room.instantiate()
#			mini_room_instance.position = prev_mini_room.position + Vector2(0, 24)
#			$HUD/MiniRooms.add_child(mini_room_instance)
#		"E":
#			mini_room_instance = mini_room.instantiate()
#			mini_room_instance.position = prev_mini_room.position + Vector2(24, 0)
#			$HUD/MiniRooms.add_child(mini_room_instance)
#		"W":
#			mini_room_instance = mini_room.instantiate()
#			mini_room_instance.position = prev_mini_room.position + Vector2(-24, 0)
